...
export const fr: Catalogue = {
  ...
  'fileReceive.allReady.title': "{count} téléphones prêts",
  'fileReceive.allReady.body': "Chaque téléphone a un produit et un coût. Vérifiez le total, puis choisissez le mode de paiement.",
  'fileReceive.matchProducts': "Associer les produits",
  'fileReceive.continue': "Passer au paiement",
  'fileReceive.continueBlocked': "{count} attendent encore une correction, ou d’être exclus.",
  ...
  'fileReceive.footer.ready': "Prêts {count}",
  'fileReceive.footer.excluded': "Exclus {count}",
  'fileReceive.group.countCost': "{count} téléphones · {total}",
  'fileReceive.group.status': "État : {status}",
  'fileReceive.group.ready': "Prêt à réceptionner",
  'fileReceive.group.mixed': "{count} à corriger, pour des raisons différentes",
  'fileReceive.group.review': "Vérifier {count} téléphones",
  'fileReceive.group.hide': "Masquer les téléphones",
  'fileReceive.match.action': "Associer le produit pour les {count}",
  ...
  'fileReceive.filter.attention': 'À corriger',
  'fileReceive.filter.excluded': 'Exclus',
  'fileReceive.state.excluded': 'Exclu',
  'fileReceive.attention.title': '{count} téléphones à corriger',
  'fileReceive.attention.body': 'Chacun doit être corrigé ou exclu avant de réceptionner la livraison.',
  ...
  'fileReceive.fix': 'Corriger ce téléphone',
  ...
  'fileReceive.bulk.body': 'S’applique aux téléphones affichés par le filtre ci-dessus. Le nombre concerné vous est indiqué avant toute modification.',
