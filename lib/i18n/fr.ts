...
export const fr: Catalogue = {
  ...
  'attention.dismiss': 'Je sais',
  'attention.dismissTitle': 'Masquer pendant une semaine ?',
  'attention.dismissBody': 'Il disparaît pour toute la boutique pendant sept jours, puis revient si c’est toujours le cas.',
