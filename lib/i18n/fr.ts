...
export const fr: Catalogue = {
  ...
  'dailyReport.result.how.body': 'Ventes nettes = ventes − retours approuvés. Coût des articles vendus = coût enregistré de chaque article vendu − coût des articles retournés. Marge brute = ventes nettes − coût des articles vendus. Résultat après dépenses = marge brute − dépenses enregistrées à ce jour. Acheter du stock n’est pas un coût tant que l’article n’est pas vendu.',
  ...
  'correctTx.kind.supplier_payment': 'Achat de stock payé',
  ...
  'correctTx.refusal.expense_not_correctable': 'Une dépense confirmée ne peut pas encore être corrigée ici',
  'correctTx.refusal.purchase_payment_not_correctable': 'Le paiement d’un achat de stock ne peut pas encore être corrigé ici',
  'correctTx.refusal.other': 'Ne peut pas être corrigé ici',
  'correctTx.open': 'Ouvrir',
  'correctTx.move': 'Déplacer vers un autre canal',
  'correctTx.move.title': 'Où cet argent est-il vraiment allé ?',
  'correctTx.move.amount': 'Montant concerné',
  'correctTx.move.reason': 'Motif',
  'correctTx.move.reason.placeholder': 'Par exemple : le client a payé par Bankily, pas en espèces',
  'correctTx.move.preview': 'Aperçu',
  'correctTx.move.from': 'Sort de {channel}',
  'correctTx.move.to': 'Entre dans {channel}',
  'correctTx.move.posts': 'Enregistré au {date}. Le paiement lui-même et chaque clôture antérieure restent inchangés.',
  'correctTx.move.dayClosed': '{date} est clôturé : la correction attendra la réouverture.',
  'correctTx.move.unchanged': 'La vente ne change pas : {collected} encaissé, {owed} dû.',
  'correctTx.move.approve': 'Corriger',
  'correctTx.move.request': 'Demander l’accord du propriétaire',
  'correctTx.move.done': 'Correction enregistrée',
  'correctTx.move.requested': 'Envoyé au propriétaire pour accord',
  'correctTx.move.failed': 'La correction n’a pas pu être enregistrée',
