...
export const fr: Catalogue = {
  ...
  'pick.choose.title': "Comment trouver le téléphone ?",
  'pick.scan': "Scanner l’IMEI",
  'pick.scan.hint': "Code-barres ou QR code sur la boîte ou le téléphone",
  'pick.manual': "Saisir l’IMEI manuellement",
  'pick.manual.hint': "Tapez le numéro à 15 chiffres",
  'pick.stock': "Choisir dans le stock",
  'pick.stock.hint': "Parmi les téléphones de ce magasin",
  ...
  'pick.stock.search': "Rechercher un modèle ou un IMEI",
  ...
  'moneyOverview.cashNow': "Espèces dans la caisse",
  'moneyOverview.cashNow.hint': "Ce que la caisse devrait contenir maintenant, après les entrées et sorties d’espèces du jour.",
  ...
  'recordPayment.before': "Dû avant ce paiement",
  ...
  'recordPayment.after': "Reste dû ensuite",
  'recordPayment.onlyReceived': "N’enregistrez que l’argent déjà reçu.",
  'recordPayment.review': "Vérifier le paiement",
  ...
  'expenses.receipt.add': "Ajouter une photo",
