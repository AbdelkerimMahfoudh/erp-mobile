...
export const fr: Catalogue = {
  ...
  'quick.sell.title': 'Vendre un téléphone',
  'pick.choose.title': "Choisissez comment trouver le téléphone",
  'pick.scan': "Scanner l’IMEI",
  'pick.scan.hint': "Scannez le code-barres ou le QR code IMEI du téléphone",
  'pick.manual': "Saisir l’IMEI manuellement",
  'pick.manual.hint': "Tapez l’IMEI affiché sur le téléphone",
  'pick.stock': "Choisir dans le stock",
  'pick.stock.hint': "Parcourez les téléphones disponibles dans ce magasin",
  'pick.manual.label': "IMEI",
  'pick.manual.either': "L’un ou l’autre IMEI d’un téléphone double SIM le retrouve.",
  'pick.manual.find': "Trouver le téléphone",
  'pick.manual.use': "Utiliser ce téléphone",
  ...
  'pick.failure.not_found': "Aucun téléphone de ce magasin n’a cet IMEI.",
  ...
  'pick.stock.search': "Rechercher un modèle, une couleur ou un IMEI",
  'pick.stock.none': "Aucun téléphone en stock ne correspond.",
  'pick.stock.more': "Afficher plus de téléphones",
  ...
  'pick.manual.title': "Saisir l’IMEI",
  'pick.manual.valid': "IMEI valide",
  'pick.manual.noStock': "Saisir un IMEI retrouve un téléphone existant. Cela ne crée pas de stock.",
  'pick.stock.title': "Choisir dans le stock",
  'pick.stock.all': "Tous",
  'pick.stock.count': "{count} téléphones disponibles",
  'pick.stock.continue': "Continuer avec ce téléphone",
  'pick.chip.available': "Disponible",
  'pick.review.title': "Vérifier la vente",
  'pick.review.note': "Le téléphone ne quitte le stock qu’une fois la vente confirmée.",
